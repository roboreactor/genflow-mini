      ...
      class i {
          ...
          Object.keys(m).map(function (t, n) {
            if (null === m[t].querySelector(".point")) {
              var h = i.querySelector("#" + e),
                ...
                _ =
                  g.offsetWidth / 2 +
                  (g.getBoundingClientRect().x - s.getBoundingClientRect().x) *
                    u,
                w =
                  g.offsetHeight / 2 +
                  (g.getBoundingClientRect().y - s.getBoundingClientRect().y) *
                    p,
                v =
                  (h = h.querySelectorAll("." + m[t].classList[4])[0])
                    .offsetWidth /
                    2 +
        ...
        createReroutePoint(e) {
          ...
          void 0 ===
            ...
            this.reroute_fix_curvature
              ? (d > 0 ||
                this.drawflow.drawflow[this.module].data[r].outputs[i]
